 ...
 */
final class Version20250929134310 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE budget_account_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE TABLE budget (id INT NOT NULL, owner_id INT NOT NULL, name VARCHAR(255) NOT NULL, currency VARCHAR(3) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_73F2F77B7E3C61F9 ON budget (owner_id)');
        $this->addSql('CREATE TABLE budget_account (id INT NOT NULL, budget_id INT NOT NULL, name VARCHAR(255) NOT NULL, balance_amount INT NOT NULL, balance_currency VARCHAR(3) NOT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE budget_account_id_seq CASCADE');
        $this->addSql('ALTER TABLE budget DROP CONSTRAINT FK_73F2F77B7E3C61F9');
        $this->addSql('ALTER TABLE budget_account DROP CONSTRAINT FK_BFB51C4536ABA6B8');
        $this->addSql('DROP TABLE budget');
        $this->addSql('DROP TABLE budget_account');
    }
}
